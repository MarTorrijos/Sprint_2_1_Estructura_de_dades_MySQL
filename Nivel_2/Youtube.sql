...
--
-- Host: localhost
-- Generation Time: Apr 08, 2025 at 10:26 AM
...
CREATE TABLE `comment_like_dislike` (
  `id_comment_like_dislike` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `video_id` int(11) NOT NULL,
...
INSERT INTO `comment_like_dislike` (`id_comment_like_dislike`, `user_id`, `video_id`, `comment_id`, `opinion`, `date_time`) VALUES
(2, 13, 4, 1, 'like', '2025-04-08 10:23:31'),
(3, 15, 3, 2, 'dislike', '2025-04-08 10:23:31');
...
INSERT INTO `subscription` (`id_subscription`, `user_id`, `channel_id`) VALUES
(1, 15, 4),
(2, 11, 1);
...
CREATE TABLE `video_like_dislike` (
  `id_video_like_dislike` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `video_id` int(11) NOT NULL,
  `opinion` enum('like','dislike') NOT NULL,
  `date_time` datetime NOT NULL
...
INSERT INTO `video_like_dislike` (`id_video_like_dislike`, `user_id`, `video_id`, `opinion`, `date_time`) VALUES
(1, 13, 3, 'like', '2025-04-01 10:16:53'),
(2, 12, 1, 'dislike', '2025-04-08 10:17:05'),
(3, 11, 1, 'like', '2025-04-03 10:17:05');
...
ALTER TABLE `comment_like_dislike`
  ADD PRIMARY KEY (`id_comment_like_dislike`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `video_id` (`video_id`),
...
ALTER TABLE `video_like_dislike`
  ADD PRIMARY KEY (`id_video_like_dislike`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `video_id` (`video_id`);
...
--
ALTER TABLE `comment_like_dislike`
  MODIFY `id_comment_like_dislike` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `video_like_dislike`
  MODIFY `id_video_like_dislike` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
